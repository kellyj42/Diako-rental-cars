...
# âœ… FIX #4: Add @login_required to draft save
@require_http_methods(["POST"])
...
# âœ… FIX #2, #25: Verify ownership + status transition validation
@login_required
def confirm_booking(request, booking_id):
    ...
    # âœ… FIX #25: Validate status transition
...
def booking_delete_view(request, booking_id):
    ...
    if request.method == "POST":
        try:
            booking.soft_delete()  # âœ… FIX #20: Use soft delete
